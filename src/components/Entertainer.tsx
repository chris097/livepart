        ...
        <div>
            <div className="mt-28 w-[75%] mx-auto">
                <h1 className="text-center text-[122px] flex items-center justify-center leading-[122px] font-bold font-mdtest tracking-[0.48px]">
                    MADE F<Image src={oletter} alt='liveparte' />R Y<Image src={os} alt='liveparte' />U ❤️
                </h1>
                <p className="text-white.100 text-[80px] leading-[80px] text-center tracking-[0.48px] font-bold font-mdtest">
                    We are making it possible for you to watch your fav<Image className="inline-block align-middle" src={of} alt='liveparte' />urite events, <br /> c<Image className="inline-block align-middle" src={oc} alt='liveparte' />nnect with your fav<Image className="inline-block align-middle" src={coc} alt='liveparte' />rite artiste and chat with
                    friends.
                </p>
            </div>
            <div className="relative w-[85%] mx-auto mt-28">
                <div className='w-full h-full relative'>
                    <svg className='w-full h-full' viewBox="0 0 1200 490" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M668.618 29C668.618 12.9837 655.635 0 639.618 0H50C22.3858 0 0 22.3858 0 50V440C0 467.614 22.3858 490 50 490H652H668.618H1150C1177.61 490 1200 467.614 1200 440V108C1200 80.3858 1177.61 58 1150 58H697.618C681.602 58 668.618 45.0163 668.618 29Z" fill="#1B1C20" />
                    </svg>
                    <div className='absolute top-1.5 w-full flex gap-5'>
                        ...
                        <div className="w-[40%] mt-2 ml-2">
                            <div className='flex justify-end w-full'>
                                <div className='bg-[#060809] h-10 rounded-r-[50px] w-full' />
                            </div>
                            <div className='pb-8 pr-3'>
                                <h1 className="font-mdtest text-[62px] leading-[62px] mt-10 font-bold tracking-[0.48px] uppercase">
                                    FOR Entertainers
                                </h1>
                                ...
                                <div className="flex items-center mt-5 gap-2">
                                    ...
                                    <p className="text-grey.200 text-base leading-[19.2px] tracking-[-0.12px] font-mattersq">Own your fan data</p>
                                </div>
                                <div className="flex items-center mt-5 gap-2">
                                    <div className="bg-red.200 w-[24px] rounded-full h-[24px] flex justify-center items-center">
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-grey.200 text-base leading-[19.2px] tracking-[-0.12px] font-mattersq">Engage with fans</p>
                                </div>
                                <button className='text-black.100 text-[13px] w-[160.29px] bg-white.200 mt-12 h-[44px] rounded-[8px] font-mattersq font-medium tracking-[-0.12px]'>Go Live</button>
                            </div>
                        </div>
                    </div>
                </div>
